...
import os
def main():
    # 获取图片真实路径 /home/dfc/chapt4/chapt4_ws/src/demo_python_service/resource/default.jpg
    ...
    #绘制人脸框
    for top,right,bottem,left in face_locations:
        cv2.rectangle(image,(left,top),(right,bottem),(255,0,0),4)
    #结果显示
